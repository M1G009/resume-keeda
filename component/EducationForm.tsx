...
import { Button, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Container } from '@mui/material';
                            ...
                            <Grid item sm={6} xs={12}>
                                <Box>
                                    ...
                                    {formik.errors.degree && formik.touched.degree && (
                                        <div className={style.error}>{formik.errors.degree}</div>
                                    )}
                                </Box>
                            ...
                            <Grid item sm={6} xs={12}>
                                <Box>
                                    ...
                                    {formik.errors.school && formik.touched.school && (
                                        <div className={style.error}>{formik.errors.school}</div>
                                    )}
                                </Box>
                            ...
                            <Grid item sm={6} xs={12}>
                                <Box>
                                    ...
                                    {formik.errors.grade && formik.touched.grade && (
                                        <div className={style.error}>{formik.errors.grade}</div>
                                    )}
                                </Box>
                            </Grid>
                            ...
                            <Grid item sm={6} xs={12}>
                                ...
                                <Box>
                                    ...
                                    {formik.errors.passingYear && formik.touched.passingYear && (
                                        <div className={style.error}>{formik.errors.passingYear}</div>
                                    )}
                                </Box>
                            </Grid>
                        ...
                        <TableBody>
                            {educationList.map((edu, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>
                                        <button className={style.remove_button} onClick={() => deleteHandler(edu.id)}>
                                            Remove
                                        </button>
                                        <button className={style.remove_button} onClick={() => updateHandler(edu, edu.id)}>
                                            Update
                                        </button>
