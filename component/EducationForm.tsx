          ...
          <form onSubmit={formik.handleSubmit} className="formborder">
            <Grid
              ...
              <Grid item sm={6} xs={12}>
                <Box>
                  <label htmlFor="degree" className="text">
                    Degree / Standard
                  </label>
                  <Box>
                    <input
              ...
              <Grid item sm={6} xs={12}>
                <Box>
                  <label htmlFor="school" className="text">
                    school
                  </label>
                  <Box>
                    <input
              ...
              <Grid item sm={6} xs={12}>
                <Box>
                  <label htmlFor="grade" className="text">
                    Percentage / Grade
                  </label>
                  <Box>
                    <input
              ...
              <Grid item sm={6} xs={12}>
                <Box>
                  <label htmlFor="passingYear" className="text">
                    Passing Year
                  </label>
                  <Box>
                    <input
              ...
              {educationList.map((edu, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>
                    ...
                    <button
                      className={styles.remove_button}
                      onClick={() => updateHandler(edu, edu.id)}>
                      Update
                    </button>
