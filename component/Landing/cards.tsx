                ...
                <Box className={style.grid} sx={{mt:7}}>
                    <Box className={style.box_purple}>
                        <Box sx={
                            ...
                            <Image src={img1} alt='' width={50} height={50} />
                        </Box>
                        <Box>
                    ...
                    <Box className={style.box_yellow}>
                        <Box sx={
                            ...
                            <Image src={img2} alt='' width={50} height={50} />
                        </Box>
                        <Box>
                    ...
                    <Box className={style.box_purple}>
                        <Box sx={
                            ...
                            <Image src={img3} alt='' width={50} height={50} />
                        </Box>
                        <Box>
                    ...
                    <Box className={style.box_yellow}>
                        <Box sx={
                            ...
                            <Image src={img4} alt='' width={50} height={50} />
                        </Box>
                        <Box>
                            <Typography sx={{ fontWeight: '400', fontSize: '30px', textAlign: 'center', color: '#f6c956',m:'25px 0 32px' }}>
                                Job tracking
                    ...
                    <Box className={style.box_purple}>
                        <Box sx={
                            ...
                            <Image src={img5} alt='' width={50} height={50} />
                        </Box>
                        <Box>
                            <Typography sx={{ fontWeight: '400', fontSize: '30px', textAlign: 'center', color: '#4F46E5',mb:'10px' }}>
                    ...
                    <Box className={style.box_yellow}>
                        <Box sx={
                            ...
                            <Image src={img6} alt='' width={50} height={50} />
                        </Box>
                        <Box>
                            <Typography sx={{ fontWeight: '400', fontSize: '30px', textAlign: 'center', color: '#f6c956',m:'25px 0 32px' }}>
                                Approved templates
