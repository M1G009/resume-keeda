                    ...
                    <Box sx={{ mt: 2 }}>
                        ...
                        <Grid container spacing={2} alignItems={'center'}>
                            ...
                            <Grid item xs={12} md={7} sx={{ p: isSmallScreen ? 2 : 0 }}>
                                <Box>
                                    <Typography variant='h4' sx={{ color: '#009e66', pb: 2 }}>Who am i ?</Typography>
                                    <Typography variant='h5' sx={{ fontWeight: 700, fontSize: isSmallScreen ? "24px" : "32px", pb: 2 }}>I'm {userFirstName} {userLastName} , a {profession}</Typography>
                                    <Typography component='p' variant='subtitle1' sx={{ color: '#9f9f9f' }}>{object}</Typography>
                                    <Divider variant="middle" />
                                    <Grid container sx={{ mb: 4 }}>
                                        <Grid item xs={12} md={6} sx={{ mb: 2 }}>
                                            <Typography sx={{ color: '#dadada' }}>Name : <span className='text-light ml-5'> {userFirstName} {userLastName}</span></Typography>
                                        </Grid>
                                        <Grid item xs={12} md={6} sx={{ mb: 2 }}>
                                            <Typography sx={{ color: '#dadada' }}>Email : <span className='text-light ml-5'><Link href=""> {userMail}</Link> </span></Typography>
                                        </Grid>
                                        <Grid item xs={12} md={6} sx={{ mb: 2 }}>
                                            <Typography sx={{ color: '#dadada' }}>Age : <span className='text-light ml-5'> {age} </span></Typography>
                                        </Grid>
                                        <Grid item xs={12} md={6} sx={{ mb: 2 }}>
                                            <Typography sx={{ color: '#dadada' }}>From : <span className='text-light ml-5'> {userAddress}</span></Typography>
                                        </Grid>
                                    </Grid>
