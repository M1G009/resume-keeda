                            ...
                            <Grid item xs={6}>
                                <Box>
                                    ...
                                    {formik.errors.companyName && formik.touched.companyName && (
                                        <div className={style.error}>{formik.errors.companyName}</div>
                                    )}
                            ...
                            <Grid item xs={6}>
                                <Box>
                                    ...
                                    {formik.errors.startDate && formik.touched.startDate && (
                                        <div className={style.error}>{formik.errors.startDate}</div>
                                    )}
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={6}>
                                <Box>
                                    ...
                                    {formik.errors.endDate && formik.touched.endDate && (
                                        <div className={style.error}>{formik.errors.endDate}</div>
                                    )}
                                </Box>
                            </Grid>
