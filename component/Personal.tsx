...
import { Button, Container, FormControlLabel, FormLabel, Grid, Radio, RadioGroup } from '@mui/material';
                            ...
                            <Grid item xs={12} sm={6} md={4}>
                                <Box>
                                    ...
                                    {formik.errors.userProfileImage && formik.touched.userProfileImage && (
                                        <div className={style.error}>{`${formik.errors.userProfileImage}`}</div>
                                    )}
                            ...
                            <Grid item xs={12} sm={6} md={4}>
                                <Box>
                                    ...
                                    {formik.errors.mobileNumber && formik.touched.mobileNumber && (
                                        <div className={style.error}>{formik.errors.mobileNumber}</div>
                                    )}
                                </Box>
                            </Grid>
                            ...
                            <Grid item xs={12} sm={6}>
                                <Box>
                                    ...
                                    {formik.errors.pincode && formik.touched.pincode && (
                                        <div className={style.error}>{formik.errors.pincode}</div>
                                    )}
                                </Box>
                            </Grid>
